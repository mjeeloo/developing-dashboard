                            ...
                            <div className="task-meta-row">
                              ...
                              {task.projectName ? (
                                <span className="meta-pill task-project">
                                  ...
                                  >
                                    <path
                                      d="M5.5 1A1.5 1.5 0 0 0 4 2.5V3h-.5A1.5 1.5 0 0 0 2 4.5v7A2.5 2.5 0 0 0 4.5 14h7a2.5 2.5 0 0 0 2.5-2.5v-7A1.5 1.5 0 0 0 12.5 3H12v-.5A1.5 1.5 0 0 0 10.5 1h-5Zm5 2h-5V2.5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 .5.5V3Z"
                                      fill="currentColor"
                                    />
                                    <path
                                      d="M1.5 6.5A.5.5 0 0 1 2 6h12a.5.5 0 0 1 .5.5V8a.5.5 0 0 1-.5.5H9v1a1 1 0 0 1-2 0v-1H2a.5.5 0 0 1-.5-.5V6.5Z"
                                      fill="currentColor"
                                    />
                                  </svg>
